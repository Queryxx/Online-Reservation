        ...
        <?php foreach ($reservations as $reservation): ?>
            <?php if (strtolower($reservation['status']) === 'pending cancellation' || strtolower($reservation['status']) === 'cancelled'): ?>
                <div class="card" data-bs-toggle="modal"
                    data-bs-target="#cancelledReservationModal<?php echo $reservation['id']; ?>">
                ...
                <!-- Full Details Modal -->
                <div class="modal fade" id="cancelledReservationModal<?php echo $reservation['id']; ?>" tabindex="-1">
                            ...
                            <p class="mr-9"><strong>Total:</strong> ₱<?php echo number_format(htmlspecialchars($reservation['pax']), 2, '.', ','); ?></p>
                                ...
                                <div class="reservation-actions">
                                    <?php if (strtolower($reservation['status']) !== 'cancelled'): ?>
                                        <a href="manage_cateringres.php?approve_cancel=<?php echo $reservation['id']; ?>#cancelled"
                                            class="btn btn-success btn-sm reservation-btn">
                                            <i class="fas fa-check"></i> Approve Cancellation
                                        </a>

                                        <a href="manage_cateringres.php?reject_cancel=<?php echo $reservation['id']; ?>"
