<!-- Navbar -->
<nav class="bg-maroon-900 shadow-lg sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <ul id="menu" class="hidden lg:flex space-x-6 items-center">
            ...
            <li><a href="index.php#menuu" class="text-white hover:bg-maroon-700 hover:text-yellow-400 p-2 rounded block"><i class="fas fa-utensils"></i> Menu</a></li>
            <li><a href="#index.php#promotions" class="text-white hover:bg-maroon-700 hover:text-yellow-400 p-2 rounded block"><i class="fas fa-concierge-bell"></i> Promotions</a></li>
            <li><a href="index.php#about" class="text-white hover:bg-maroon-700 hover:text-yellow-400 p-2 rounded block"><i class="fas fa-calendar-check"></i> About Us</a></li>
            <li><a href="index.php#contact" class="text-white hover:bg-maroon-700 hover:text-yellow-400 p-2 rounded block"><i class="fas fa-phone-alt"></i> Contact</a></li>
            <?php if (isset($_SESSION['user_id'])): ?>
                <li class="relative">
                    <a href="userdashboard.php" id="account-toggle" class="p-2 rounded block flex items-center ">
                        <img src="<?php echo htmlspecialchars($_SESSION['profile_picture'] ?? 'default.jpg'); ?>" alt="Profile Picture" class="w-10 h-10 hover:border-yellow-400 rounded-full border-2 border-white">
    ...
    <ul id="mobile-menu" class="menu-enter hidden lg:hidden flex flex-col space-y-4 bg-gray-100 p-4">
        ...
        <li><a href="index.php#menuu" class="text-gray-600 hover:text-gray-800"><i class="fas fa-utensils mr-2"></i> Menu</a></li>
        <li><a href="index.php#promotions" class="text-gray-600 hover:text-gray-800"><i class="fas fa-concierge-bell"></i> Promotions</a></li>
        <li><a href="index.php#about" class="text-gray-600 hover:text-gray-800"><i class="fas fa-calendar-check"></i> About Us</a></li>
        <li><a href="index.php#contact" class="text-gray-600 hover:text-gray-800"><i class="fas fa-phone-alt"></i> Contact</a></li>
        <?php if (isset($_SESSION['user_id'])): ?>
            <li class="relative">
                <a href="userdashboard.php" id="mobile-account-toggle" class="hover:bg-maroon-700 p-2 rounded block">
